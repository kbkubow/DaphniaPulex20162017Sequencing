...
### Do some filtering on read depth and independence
  scrd5 <- sc[medrd>4 & Nonindependent==0 & LabGenerated==0]
...
### Read in only G files first to figure out how to make the figure
      ...
      total$type <- factor(total$type, levels=c("AvsC", "AvsCvsother", "withinpond", "betweenpond",
        "vsD10", "vsW1", "vsW6", "vsPulicaria", "vsObtusa"))
      total$ACvspondB <- factor(total$ACvspondB, levels=c("A_D8DBunk_C_D8DBunk", "D8DBunkDCatvsA", "D8DBunkDCatvsC",
        "D8_D8", "DBunk_DBunk", "DCat_DCat", "D8_DBunk", "D8_DCat", "DBunk_DCat", "A_D10",
        "C_D10", "D8DBunkDCatvsD10", "A_W1",  "C_W1", "D8DBunkDCatvsW1", "A_W6", "C_W6", "D8DBunkDCatvsW6",
        "A_pulicaria", "C_pulicaria", "D8DBunkDCatvsPulicaria", "A_obtusa", "C_obtusa", "D8DBunkDCatvsObtusa"))

      total$outgroup <- ifelse(total$type=="vsPulicaria" | total$type=="vsObtusa", "Between_Species", "Within_Species")
      total$outgroup <- factor(total$outgroup, levels=c("Within_Species", "Between_Species"))
      ...
      ggsave(boxwhiskerIBS, file="boxwhiskerIBS_20200819.pdf")

      boxwhiskerIBSnoACvsother <- ggplot(data=total[type!="AvsCvsother"], aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_boxplot() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

      ggsave(boxwhiskerIBSnoACvsother, file="boxwhiskerIBSnoACvsother_20200819.pdf")

      boxwhiskerIBSfacet <- ggplot(data=total, aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_boxplot() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
        facet_wrap(~outgroup,scales="free")

      ggsave(boxwhiskerIBSfacet, file="boxwhiskerIBSfacet_20200819.pdf")

      boxwhiskerIBSnoACvsotherfacet <- ggplot(data=total[type!="AvsCvsother"], aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_boxplot() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
        facet_wrap(~outgroup,scales="free")

      ggsave(boxwhiskerIBSnoACvsotherfacet, file="boxwhiskerIBSnoACvsotherfacet_20200819.pdf")


      boxwhiskerIBSviolin <- ggplot(data=total, aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_violin() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

      ggsave(boxwhiskerIBSviolin, file="boxwhiskerIBSviolin_20200819.pdf")

      boxwhiskerIBSnoACvsotherviolin <- ggplot(data=total[type!="AvsCvsother"], aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_violin() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

      ggsave(boxwhiskerIBSnoACvsotherviolin, file="boxwhiskerIBSnoACvsotherviolin_20200819.pdf")

      boxwhiskerIBSfacetviolin <- ggplot(data=total, aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_violin() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
        facet_wrap(~outgroup,scales="free")

      ggsave(boxwhiskerIBSfacetviolin, file="boxwhiskerIBSfacetviolin_20200819.pdf")

      boxwhiskerIBSnoACvsotherfacetviolin <- ggplot(data=total[type!="AvsCvsother"], aes(x=ACvspondB, y=meanIBS, color=as.factor(type))) + geom_violin() +
        theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
        theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
        facet_wrap(~outgroup,scales="free")

      ggsave(boxwhiskerIBSnoACvsotherfacetviolin, file="boxwhiskerIBSnoACvsotherfacetviolin_20200819.pdf")
      ...
      ggplot(data=totalttest, aes(x=comppond, y=mean_ratiosim, group=comppond)) + geom_boxplot() +
      geom_hline(yintercept=1,color="red") +
      theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
      panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
      theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + facet_wrap(~outgroup,scales="free")
