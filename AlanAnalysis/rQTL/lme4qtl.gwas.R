...
#### using lme4qtl
  lmer.gwas <- foreach(i=pio.ag.ag$id[100:110], .errorhandling="remove")%dopar%{
  ...
  save(lmer.gwas, file=paste("/scratch/aob2x/daphnia_hwe_sims/lmer4qtl/perm", perm, ".Rdata", sep=""))
