...
# sacct -j 15196734
# cat /scratch/aob2x/daphnia_hwe_sims/slurmOut/trioPhase_whatshapp.15196737_10.err
...
### which f1s
  ...
  Rscript ${wd}/DaphniaPulex20162017Sequencing/AlanAnalysis/rQTL/rabbit.format_input.maxRD.readCounts.R ${chr} ${cm} ${set}
