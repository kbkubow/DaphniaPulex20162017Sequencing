...
#SBATCH --cpus-per-task=5 ### standard has 28 or 40 $SLURM_CPUS_PER_TASK
#SBATCH -t 2:00:00 # Running time of 2 hours
#SBATCH --mem 40G # Memory request of 12 GB
...
## sacct -u aob2x -j 9995651
## cat /scratch/aob2x/daphnia_hwe_sims/slurmOut/popPhasing_whatshapp.9995651_4294967294.err
