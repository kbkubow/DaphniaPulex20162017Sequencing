...
### clump-test
  ...
  A <- makeGRangesFromDataFrame(as.data.frame(o[pairs%in%c("D8Male1_D8PE1", "D8Male1_D8PE2", "D8Male2_D8PE1", "D8Male2_D8PE2")][use.chr==T][p<1e-2][,list(start=pos), list(chr, end=pos)]),
