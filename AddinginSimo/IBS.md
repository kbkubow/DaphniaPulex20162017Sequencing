...
```
 ...
 Based on this, I am making a decision to make the threshold for superclone inclusion at 0.9865. We can discuss this.
...
# Load genotype file and snp and sample filter files
        ...
        sampleidsnosuperlow <- sampleidsdt$sample.ids[sample.ids!="March20_2018_DBunk_39" & sample.ids!="March20_2018_D8_19" & sample.ids!="Fall_2016_D10_54" &
          sample.ids!="Spring_2017_DRampsSimo_3" & sample.ids!="Spring_2017_D8Simo_1"]
...
# Run IBS
  ...
  ### Identify superclones
    ...
    ### rename singletone individuals to "OO" to follow Karen's convention
        ...
        write.table(sc.dt, file="Superclones20161718withlowcoverageindupdated_20190501", sep="\t", row.names=FALSE, quote=FALSE)
