...
Right now the minimum number of individuals genotyped per SNP is 345 out of 405, which is just about 85%. I am going to leave this as is for now. So let's save a final set of SNP ids.
```
